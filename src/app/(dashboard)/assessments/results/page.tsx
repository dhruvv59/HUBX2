...
function FilterSidebar({ filters, onFilterChange }: FilterSidebarProps) {
    ...
    return (
        <div className="w-full lg:w-[280px] shrink-0 space-y-4">
            ...
            <button className="w-full bg-white rounded-[20px] p-6 shadow-sm border border-orange-200 flex items-center justify-between group hover:border-orange-400 transition-colors">
                <span className="text-[13px] font-bold italic text-gray-900">VIEW MARKED QUESTIONS</span>
                <div className="h-8 w-8 rounded-full border border-gray-200 flex items-center justify-center bg-white group-hover:bg-gray-50">
