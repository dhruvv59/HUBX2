...
export default function TakeAssessmentPage() {
    ...
    const confirmSubmit = async () => {
        ...
        try {
            ...
            router.push("/assessments/results"); // In a real app, maybe show a Success Modal first
        } catch (err) {
        ...
        <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans">
            ...
            <div className="flex-1 max-w-[1600px] mx-auto w-full p-6 grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 lg:col-span-8 flex flex-col">
                    <div className="bg-white rounded-[24px] shadow-sm p-8 min-h-[600px] flex flex-col relative">
                        {/* Question Header */}
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="flex items-center space-x-2">
                                <button className="p-2 text-gray-400 hover:text-orange-500 hover:bg-orange-50 rounded-full transition-colors" title="Help">
                ...
                <div className="col-span-12 lg:col-span-3 space-y-6">
                    ...
                    {/* Progress Card */}
                    <div className="bg-white rounded-[24px] shadow-sm p-6 border border-purple-100">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Wrong Answers</span>
                            ...
                            <div className="flex justify-between items-center text-gray-500">
                                <div className="flex items-center">
                                    <span className="text-xs font-bold uppercase tracking-wider">Doubts</span>
                            ...
                            <div className="flex justify-between items-center text-gray-500">
                                <div className="flex items-center">
                                    <span className="text-xs font-bold uppercase tracking-wider">Ask Teacher</span>
                            ...
                            <div className="flex justify-between items-center text-gray-500">
                                <div className="flex items-center">
                                    <span className="text-xs font-bold uppercase tracking-wider">Marked Question</span>
                    ...
                    {/* Score Card */}
                    <div className="bg-white rounded-[24px] shadow-sm p-6 border border-gray-100 min-h-[160px] flex flex-col justify-center items-center text-center">
                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Assessment Score</h3>
                        <div className="text-[40px] font-black italic text-gray-900 leading-none">
                            195<span className="text-[24px] text-gray-400">/300</span>
                        </div>
                    </div>
