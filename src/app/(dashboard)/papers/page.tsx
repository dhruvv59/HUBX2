    ...
    const filterContent = (
        <>
            ...
            <div className="space-y-4">
                ...
                <button className="w-full bg-white rounded-[20px] p-5 shadow-sm border border-orange-200 flex items-center justify-between group hover:border-orange-400 transition-all min-h-[56px]">
