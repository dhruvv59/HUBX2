...
export function PracticePapersClient({ initialData }: PracticePapersClientProps) {
    ...
    const [stats, setStats] = useState<PaperStats>(initialData.stats);
    ...
    // Fetch Papers (Client-side mainly for filtering/pagination now)
    ...
    // Only fetch on client IF filters/page change (skip initial mount fetch as we have data)
