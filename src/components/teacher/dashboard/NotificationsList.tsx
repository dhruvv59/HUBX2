...
export function NotificationsList({ notifications }: { notifications: NotificationItem[] }) {
    return (
        <div className="bg-[#f8f9ff] p-6 rounded-2xl border border-indigo-50/50 flex flex-col h-full">
            <h3 className="font-bold text-gray-800 mb-6 text-lg">Notifications from Student</h3>
            ...
            <button className="w-full mt-6 py-3.5 border border-gray-300 rounded-xl bg-white text-sm font-extrabold text-gray-700 hover:bg-gray-50 hover:border-gray-400 hover:text-gray-900 transition-all shadow-sm">
                View All
            </button>
        </div>
    );
