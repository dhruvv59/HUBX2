...
export function Banners() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="lg:col-span-2 h-[110px] relative overflow-hidden rounded-2xl bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-yellow-100 via-blue-100 to-red-100 flex items-center px-8 shadow-sm border border-gray-100 cursor-pointer hover:shadow-md transition-all">
