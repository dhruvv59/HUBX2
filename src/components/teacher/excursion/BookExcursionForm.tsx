            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <select
                            className="w-full h-12 px-4 rounded-xl border border-gray-200 bg-white text-gray-900 font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-100 appearance-none cursor-not-allowed"
                            disabled
