...
export function PaperCard({ data }: PaperCardProps) {
    const { title, count, badgeCount, borderColorClass } = data;

    return (
        <div className={cn(
            "bg-white rounded-[24px] p-6 border shadow-sm relative h-[100px] flex flex-col justify-center hover:shadow-md transition-shadow cursor-pointer",
